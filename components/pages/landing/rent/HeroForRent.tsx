      ...
      <div className="absolute top-1/2 lg:right-40 right-8 -translate-y-1/2">
        ...
        >
          ...
          <p className={cn(
            ...
            Browse our selection of quality rental properties. Find your ideal home with flexible lease terms and professional management.
          </p>
