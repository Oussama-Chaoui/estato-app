...
const features = [
  {
    ...
    description: "Carefully curated selection of verified rental properties.",
  },
  {
    icon: <ShieldCheck size={56} className="text-primary-500" />,
    title: "Verified Landlords",
    description: "Trusted property owners and professional managers.",
  },
  {
    icon: <PiggyBank size={56} className="text-primary-500" />,
    title: "Flexible Terms",
    description: "Customizable lease agreements that fit your lifestyle.",
  },
  {
    icon: <Headphones size={56} className="text-primary-500" />,
    title: "24/7 Support",
    description: "Dedicated assistance throughout your tenancy.",
  },
];

const FeaturesForRent = () => {
  return (
...
export default FeaturesForRent; 