...
const features = [
  {
    ...
    description: "Exquisite homes designed for elegance and comfort.",
  },
  {
    icon: <ShieldCheck size={56} className="text-primary-500" />,
    title: "Trusted Agents",
    description: "Certified real estate professionals with extensive experience.",
  },
  {
    icon: <PiggyBank size={56} className="text-primary-500" />,
    title: "Smart Investments",
    description: "High ROI opportunities with carefully selected properties.",
  },
  {
    icon: <Headphones size={56} className="text-primary-500" />,
    title: "24/7 Support",
    description: "Dedicated assistance throughout your entire journey.",
  },
];
