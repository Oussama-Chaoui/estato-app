...
import { Search, MapPin, Calendar, ChevronDown, ChevronUp, Home, Bed, Bath, Star, Wallet, ChevronsUpDown, Eraser } from "lucide-react";
...
const DailyPropertiesFilter = forwardRef<any, DailyPropertiesFilterProps>(({
  ...
  const activeFiltersCount = useMemo(() => {
    ...
    return count;
  }, [location, dateRange, propertyType, minPrice, isMaxPriceActive, maxPrice, bedrooms, bathrooms, selectedAmenities, showAdvancedFilters]);
