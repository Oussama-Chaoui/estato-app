...
export const generateMetadata = async ({ params }: Params): Promise<Metadata> => {
  ...
  const meta = buildPropertyMetadata(property, WEBSITE_FOCUS.SELLING, locale);

  const canonical = buildCanonical(AppRoutes.Properties.HomeSale.ReadOne.replace('{id}', params.id));
